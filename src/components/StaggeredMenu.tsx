  ...
  return (
    ...
    >
      <div
        className={
          (className ? className + " " : "") +
          "staggered-menu-wrapper relative w-full h-full z-50"
        }
        style={
          accentColor
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle ml-auto relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto text-base ${
              open ? "text-purple-900" : "text-white"
            }`}
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            >
              {items && items.length
                ? items.map((it, idx) => (
                    ...
                    >
                      <a
                        className="sm-panel-item relative text-purple-900 font-bold text-[4rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline hover:text-purple-600"
                        href={it.link}
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              ...
              >
                <h3 className="sm-socials-title m-0 text-base font-medium text-purple-600">
                  Connect
                </h3>
                <ul
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; z-index: 60; }
...
.sm-scope .sm-toggle:focus-visible { outline: 2px solid #a78bfa; outline-offset: 4px; border-radius: 4px; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 55; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 420px); pointer-events: none; z-index: 45; }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #a78bfa); outline-offset: 3px; }
...
.sm-scope .sm-panel-item { position: relative; font-weight: 600; font-size: 4rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: color 0.25s; display: inline-block; text-decoration: none; }
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0; left: 100%; margin-left: 0.3em; font-size: 14px; font-weight: 400; color: var(--sm-accent, #a78bfa); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
@media (max-width: 1024px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } .sm-scope .sm-panel-item { font-size: 3rem; } }
